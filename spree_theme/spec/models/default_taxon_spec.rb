...
describe DefaultTaxon do
  ...
  it "instantiate by context" do
    DefaultTaxon::ContextEnum.each{|context|
      next if [ DefaultTaxon::ContextEnum.search, DefaultTaxon::ContextEnum.list, DefaultTaxon::ContextEnum.detail, DefaultTaxon::ContextEnum.blog, DefaultTaxon::ContextEnum.post,DefaultTaxon::ContextEnum.thanks, DefaultTaxon::ContextEnum.password].include? context
