class Spree::Admin::PostProductsController < Spree::Admin::BaseController
  ...
  def create
    ...
    render :partial => "spree/admin/post_products/related_products_table", :locals => { :post => @post }, :layout => false
  end
