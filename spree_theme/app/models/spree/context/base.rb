module Spree
  module Context
    module Base
      ...
      ContextDataSourceMap = Hash.new( [:taxonomy, :taxon, :gpvs, :blog, :gpvs_theme] ).merge!( { ContextEnum.detail=>[:this_product,:related_products], ContextEnum.post=>[:post] } )
      DataSourceChainMap = {
        taxon: [:gpvs,:blog],
      ...
      DataSourceEnum  = Struct.new(:none,:gpvs, :this_product, :taxonomy, :taxon, :related_taxon, :blog, :post,:related_posts, :related_products, :gpvs_theme )\
        [:'', :gpvs, :this_product, :taxonomy, :taxon, :related_taxon, :blog, :post,:related_posts, :related_products, :gpvs_theme]
      DataSourceNone = :""
