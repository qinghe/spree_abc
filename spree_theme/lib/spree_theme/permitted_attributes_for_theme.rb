module Spree
  module PermittedAttributes
    ...
    @@section_attributes = [ :section_piece_id, :title, :global_events, :subscribed_global_events,:is_enabled ]
    @@template_file_attributes = [ :theme_id, :attachment, :page_layout_id ]
    @@template_text_attributes = [ :name, :body ]
    @@template_theme_attributes = [ :is_public, :site_id,:page_layout_root_id,:title, :section_root_id, :assigned_resource_ids ]
