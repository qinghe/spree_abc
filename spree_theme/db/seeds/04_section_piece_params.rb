objs=[
  ...
  {"id"=>5, "editor_id"=>2, "section_piece_id"=>1, "class_name"=>"page", "pclass"=>"css", "param_category_id"=>2,  "html_attribute_ids"=>"21,20"},
  ...
  {"id"=>8, "editor_id"=>2, "section_piece_id"=>1, "class_name"=>"content_layout", "pclass"=>"bool", "param_category_id"=>1,  "html_attribute_ids"=>"85"},
  {"id"=>9, "editor_id"=>3, "section_piece_id"=>1, "class_name"=>"page", "pclass"=>"css", "param_category_id"=>2,  "html_attribute_ids"=>"2,3,4,5"},
  {"id"=>10, "editor_id"=>4, "section_piece_id"=>1, "class_name"=>"page", "pclass"=>"css", "param_category_id"=>2,  "html_attribute_ids"=>"23,24,25,26,27,16,49,53,54,55,56,52,58,57"},
