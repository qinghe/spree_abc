...
product_image_with_thumbnails = Spree::Section.create_section(section_piece_hash['container'], {:title=>"product image with thumbnails2"},
  {'block'=>{'disabled_ha_ids'=>'111'}, 'inner'=>{'15hidden'=>bool_true}})  
product_image_with_thumbnails.add_section_piece(section_piece_hash['product_main_image'])
product_image_with_thumbnails.add_section_piece(section_piece_hash['product_thumbnails'])
