...
dialog = Spree::Section.create_section(section_piece_hash['dialog'].id, {:title=>"dialog3"})


dialog_container = dialog.add_section_piece(section_piece_hash['container'].id, 
...
dialog_content = dialog_container.add_section_piece(section_piece_hash['dialog-content'].id)
dialog_content.add_section_piece(section_piece_hash['container-form'].id ).add_section_piece(section_piece_hash['container-table'].id )
