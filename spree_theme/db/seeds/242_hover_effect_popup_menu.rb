...
container = Spree::Section.create_section( section_piece_hash['container'], {:title=>"hover effect popup menu container", :content_param=>  Spree::Section::HoverEffect.popup_menu, :usage=>'container'},
