...
Spree::Section.where(:title=>'swiper for taxon').each(&:destroy)
container = Spree::Section.create_section( section_piece_hash['container'], {:title=>"swiper for taxon"},
...
container.add_section_piece(section_piece_hash['swipper-core']).add_section_piece(section_piece_hash['swipper-data-taxons'])
