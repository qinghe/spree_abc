...
option_presentation = { "editor_id"=>2,  "class_name"=>"header3", "pclass"=>"css", "param_category_id"=>6,  "html_attribute_ids"=>"31,32,7,8,6"}  
...
option_presentation = { "editor_id"=>3,  "class_name"=>"header3", "pclass"=>"css", "param_category_id"=>6,  "html_attribute_ids"=>"2,3,4,5"}  
unless Spree::SectionPieceParam.where( option_presentation ).present?
  create_section_piece_param( section_piece, option_presentation)
end
