module Spree
  #disable it temperately, updated it for new spree 2.4, especially create order from backend.
  ...
  #      else
  #        line_item = order.line_items.new(quantity: quantity, variant_id: variant.id)
  #        line_item.target_shipment = shipment
  #
